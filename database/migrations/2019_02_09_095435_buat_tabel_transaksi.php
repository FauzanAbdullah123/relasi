...
class BuatTabelTransaksi extends Migration
{
    ...
    public function up()
    {
        Schema::create('transaksi', function (Blueprint $table) {
            ...
            $table->foreign('id_minuman')->references('id')->on('minuman')->onDelete('CASCADE');  
            $table->unsignedInteger('id_makanan');
            $table->foreign('id_makanan')->references('id')->on('makanan')->onDelete('CASCADE');        
            $table->integer('jmlh_makanan');
            $table->integer('jmlh_minuman');

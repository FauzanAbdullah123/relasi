    ...
    <div class="sidebar-content">
        ...
        <nav class="main-menu">
            <ul class="nav metismenu">
                ...
                <li class="nav-item">
					<a class="nav-link" href="{{ url('/biodata') }}"><span>Biodata</span></a>
				</li>
					<li class="nav-item">
						<a class="nav-link" href="{{ url('/customer') }}"><span>Customer</span></a>
					</li>
					<li class="nav-item">
					    <a class="nav-link" href="{{ url('/dosen') }}"><span>Dosen</span></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="{{ url('/hobi') }}"><span>Hobi</span></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="{{ url('/mahasiswa') }}"><span>Mahasiswa</span></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="{{ url('/makanan') }}"><span>Makanan</span></a>
					</li>
						<li class="nav-item">
						<a class="nav-link" href="{{ url('/minuman') }}"><span>Minuman</span></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="{{ url('/supplier') }}"><span>Supplier</span></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="{{ url('/transaksi') }}"><span>Transaksi</span></a>
					</li>
					<li class="nav-item">
					    <a class="nav-link" href="{{ url('/wali') }}"><span>Wali</span></a>
                    </li>	
                    </li>
            </ul>
        </nav>

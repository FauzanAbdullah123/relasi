...
<body style="background-color: #e84118">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel" style="background-color: #00a8ff">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/minuman') }}">Minuman</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/makanan') }}">Makanan</a>
                        </li>
                        <li class="nav-item">
